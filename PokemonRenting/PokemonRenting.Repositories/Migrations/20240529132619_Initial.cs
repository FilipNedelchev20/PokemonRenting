        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PokemonName = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    PokemonType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PokemonNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PokemonColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    PokemonPrice = table.Column<decimal>(type: "money", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rental_Pokemons_PokemonId",

...
namespace PokemonRenting.Repositories.Migrations
{
    ...
    [Migration("20240618055539_AddingPropertyQuantity")]
    partial class AddingPropertyQuantity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PokemonRenting.Models.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PokemonRenting.Models.UserDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TrainerLevel")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PokemonRentingModels.Pokemon", b =>
                {
                    ...
                    b.Property<string>("PokemonColor")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PokemonNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("PokemonPrice")
                        .HasColumnType("money");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PokemonRenting.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PokemonRenting.Models.Cart", b =>
                {
                    b.HasOne("PokemonRentingModels.Pokemon", "Pokemon")
                        .WithMany()
